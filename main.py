...
def generar_pdf(datos: dict) -> str:
    ...
    try:
        ...
        if os.path.exists(plantilla):
            ...
            pg.insert_text((275, 161), "PLACAS, TARJETA DE CIRCULACIÓN Y SIN ENGOMADO", fontsize=10, fontname="hebo", color=(0,0,0))
            ...
            if img_qr:
                ...
                pg.insert_image(fitz.Rect(310, 395, 385, 470), pixmap=fitz.Pixmap(buf.read()), overlay=True)
        else:
