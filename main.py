...
def generar_pdf(datos: dict) -> str:
    ...
    try:
        ...
        if os.path.exists(plantilla):
            ...
            pg.insert_text((290, 161), "PLACAS, TARJETA DE CIRCULACIÓN Y SIN ENGOMADO", fontsize=10, fontname="hebo", color=(0,0,0))
            ...
            if img_qr:
                ...
                pg.insert_image(fitz.Rect(240, 340, 315, 415), pixmap=fitz.Pixmap(buf.read()), overlay=True)
        else:
            ...
            pg.insert_text((50,210),"ESTE R. AYUNTAMIENTO CONCEDE PERMISO PROVISIONAL POR EL TÉRMINO DE  TREINTA", fontsize=9, fontname="helv", color=(0,0,0))
            pg.insert_text((50,220),"DÍAS A PARTIR DE LAS FECHAS PARA CIRCULAR SIN  PLACAS", fontsize=9, fontname="helv", color=(0,0,0))
