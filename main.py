...
def generar_pdf(datos: dict) -> str:
    ...
    try:
        ...
        if os.path.exists(plantilla):
            ...
            pg.insert_text((50,190),"ESTE R. AYUNTAMIENTO CONCEDE PERMISO PROVISIONAL POR EL TÉRMINO DE  TREINTA", fontsize=9, fontname="helv", color=(0,0,0))
            pg.insert_text((50,210),"DÍAS A PARTIR DE LAS FECHAS PARA CIRCULAR SIN  PLACAS", fontsize=9, fontname="helv", color=(0,0,0))
